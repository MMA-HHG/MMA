...
\end{array}}
\underbrace{
\left[\widehat{\partial_t j}(\tilde{z},\tilde{\rho},\omega)\right]_{F_v}
}_{\begin{array}{c}
\text{dipole acceleration}\\ 
...
\frac{\omega}{c}
\left[
n(\tilde{\tilde{z}},\tilde{\rho},\omega)-n_{\mathrm{eff}}
\right]
...
$$ \Phi_{\text{total}} = \Phi - \mathrm{arg} \left( [\widehat{\partial_t j}]_{F_{v}}\right) = \Phi -\frac{\omega n_{\mathrm{IR}}}{c}z + \frac{\omega z}{v}  = \\ = \int_0^z \left( \frac{\omega n_{\mathrm{XUV}}}{c} -\frac{\omega}{v} \right) \, \mathrm{d}z -\frac{\omega n_{\mathrm{IR}}}{c}z + \frac{\omega z}{v} = \\ = \frac{\omega}{c}(n_{\mathrm{XUV}}-n_{\mathrm{IR}})z = \frac{\omega}{c} (\chi_{\mathrm{XUV}} - \chi_{\mathrm{IR}}) . $$

* This is the expected outcome where the signal is perfectly phase-matched (all the emitters are in phase and sum constructively) for $`\chi_{\mathrm{XUV}} = \chi_{\mathrm{IR}}`$.
