...
H_cutoff = HHG.ComputeCutoff(I0_grid[k_I0], mn.ConvertPhoton(lambdaSI, 'lambdaSI', 'omegaau'), HHG.Ip_list['Ar'])[1]
H_Ip = HHG.Ip_list['Ar']/mn.ConvertPhoton(lambdaSI, 'lambdaSI', 'omegaau')
