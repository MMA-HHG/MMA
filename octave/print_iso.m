function print_iso(inpath,outpath,format,resolution,w0cm,tpfs,lambdanm,n0,PcrGw,rhoccm3,rhontcm3,sigmak,KK,zminm,zmaxm,rmaxmm,tminfs,tmaxfs,intmintwcm2,intmaxtwcm2,omegaminhz,omegamaxhz);
