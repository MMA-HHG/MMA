...
!     INTEGER(HSIZE_T), DIMENSION(3) :: dimsfi 
	...
	DO k2=1, dim_t
		Fields(1,k1,k2) = REAL(my_rank,4) !REAL( REAL( (efield_factor*efield_osc(k2)*e(k2,r_offset+k1)) ) , 4 ) ! SINGLE PRECISION, corresponding H5T_NATIVE_REAL (REAL(.,8) corresponds to H5T_NATIVE_DOUBLE)
	ENDDO
	ENDDO
