...
character(len=255), parameter :: available_tests(N_tests) = [character(len=255) :: "test", "test2", "GfP", "GfI", "GfFWHME",& 
                                                        ...
                                                        "test_modulations_base_half_dens", "test_modulations_base_half_dens_table" ] ! "GfH5w_pre_ionised_PPT"
...
! pre-ionized
    ...
    if ( any(test_number == (/34/)) ) then
        ...
        call create_dset(group_id2, 'table', (/ 0.5d0 , 0.5d0 /), 2)
