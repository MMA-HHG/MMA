...
character(len=255), parameter :: available_tests(N_tests) = [character(len=255) :: "test", "test2", "GfP", "GfI", "GfFWHME",& 
                                                        ...
                                                        "test1_TDSE_mod", "test1_TDSE_mod_inc", "test1_TDSE_mod_dec"] ! "GfH5w_pre_ionised_PPT"
...
! pre-ionized
    ...
    if ( any(test_number == (/34,37,39,41,42, &
        ...
        if ( test_number == 292 ) call create_dset(group_id2, 'table', (/ 1.d0/1.0d2   , 1.d0/1.0d2  /), 2)
        if ( test_number == 293 ) call create_dset(group_id2, 'table', (/ 1.d0/1.0d-2  , 1.d0/1.0d-2 /), 2)
