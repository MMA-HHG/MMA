...
python3 $UNIV_INPUT_PATH/create_universal_HDF5.py -i $TDSE_1D_HOME/processing/convergences/TDSE_convergence1_2Nxdx2.inp -ihdf5 fields_list.h5 -ohdf5 results.h5 -g TDSE_inputs 
