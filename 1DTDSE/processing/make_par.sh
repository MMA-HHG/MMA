...
python3 $UNIV_INPUT_PATH/create_universal_HDF5.py -i $TDSE_1D_HOME/processing/FreeFormInputs_TDSE_par1.inp -ihdf5 fields_list.h5 -ohdf5 results.h5 -g TDSE_inputs 
