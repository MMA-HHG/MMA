PROGRAM test_modules
  ...
  do k1 = 1,11
    call interpolate_lin(x_test(k1),fx,default_array,default_array,Np)
    print *, x, fx  
  enddo

  print *,"tip"
  do k1 = 1,11
    call interpolate_lin(x_test(k1),fx,default_array,default_array,Np, k_tip = 50)
    print *, x, fx  
  enddo
